        ...
        <div className="container mb-5">
          <div className="row">
            ...
            <div className="col-12 col-lg-7 our-services-list">
              ...
              <br />
              <button className="btn-style btn-style-hover">learn more</button>
            </div>
          </div>
        </div>
      </section>
      ...
      {/*<section className="common-section our-services our-services-rightside">
        <div className="container mb-5">
          <div className="row">
            ...
            <div className="col-12 col-lg-7 our-services-rightside-content d-flex justify-content-center align-items-center flex-column">
